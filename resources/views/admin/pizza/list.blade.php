              ...
              <div class="card-header">
                <h3 class="card-title">
                    <a href="{{ route('admin#createPizza')}} ">
                        <button class="btn btn-sm bg-success text-white mt-1"><i class="fas fa-plus-circle"></i></button>
                    </a>
                ...
                <a href="{{ route('admin#pizzaDownload') }}"><button class="btn btn-success btn-sm me-3 mt-1">Download CSV </button></a>
                ...
                <table class="table table-hover text-nowrap text-center">
                  ...
                  <tbody>
                   ...
                   <tr>
                       ...
                       <td>
                    <img src="{{ asset('uploadsImage/'.$item->image ) }}" class="img-thumbnail" width="150px">
                       </td>
                       ...
                       <td>
                       @if ($item->buy_one_get_one_stauts == 1)
                          Yes
                       @elseif ($item->buy_one_get_one_stauts == 0)
                           No
                        @endif
                       </td>
                       <td>
